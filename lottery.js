...
var lottery = {
    ...
    _down: function () {
        ...
        var _this = this;
        // console.log("转盘减速",_this.options.speed,_this.options.downMax,this.options.target,_this._index())
    ...
    aim: function () {
        if (this.options.aim) {
            ...
            console.log('oooo1111111111',this.options.target);
        }
    }
};
